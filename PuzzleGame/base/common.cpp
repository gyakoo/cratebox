...
namespace Game
{
    ...
    void Engine::DrawCircle(uint32_t x, uint32_t y, uint32_t radius, const Color& color)
    {
        //SDL_SetRenderDrawColor(m_sdlRenderer, color.r, color.g, color.b, color.a);
        aacircleRGBA(m_sdlRenderer, (Sint16)x, (Sint16)y, (Sint16)radius, color.r, color.g, color.b, color.a);
    }
