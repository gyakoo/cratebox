...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "ratastory.py"
 
        #Name of program
        self.project_name = "Rata Story"
 
        #Project url
        self.project_url = "https://github.com/gyakoo?tab=repositories"
        ...
        self.copyright = "Copyright (c) 2015 gyakoo"
 
        #Description
        self.project_description = "Rata Story"
